...
politicas_ecomart = carrega('ProjetoBase/dados/políticas_ecomart.txt')
dados_ecomart = carrega('ProjetoBase/dados/dados_ecomart.txt')
produtos_ecomart = carrega('ProjetoBase/dados/produtos_ecomart.txt')
